    ...
    <section class="content">
    	<div class="box">
          ...
          <div class="col-md-2 col-md-offset">
                    ...
                    <form action="<?php echo base_url('rawat_inap/report'); ?>" method="post">
        ...
        <div class="pull-right">
            <a href="<?= base_url('rawat_inap/cetak/'.'?dari='.set_value('dari').'&sampai='.set_value('sampai')) ?>" target="_blank" class="btn btn-primary btn-flat"><i class="fa fa-print"></i> Cetak</a>
            <a href="<?= base_url('rawat_inap/cetak_pdf/'.'?dari='.set_value('dari').'&sampai='.set_value('sampai')) ?>) ?>" target="_blank" class="btn btn-success btn-flat"><i class="fa fa-file-pdf-o"></i> PDF</a>
          ...
          <tbody>
            <?php $no = 1;
                  $grand_total = 0;
                        ...
                        <td style="text-align: center;"><?= $data->no_kamar ?></td> 
