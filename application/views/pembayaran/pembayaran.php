          ...
          <div class="row">
            <div class="col-xs-12">
              <h2 class="page-header">
                <i class="fa fa-medkit"> Kepada Pasien : <?= $rm->nama_pasien ?></i> 
			...
			<div class="box-body">
    		  <div class="row">
                <div class="col-md-6 col-md-offset-2">
                    ...
                    <form action="<?= base_url('pembayaran/add_obat/'.$rm->no_rm)?>" method="post">
      ...
      <div class="row">
        ...
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-xs-12">
              <h2 class="page-header">
              <form action="<?= base_url('pembayaran/add_pembayaran/'.$rm->no_rm)?>" method="post">
                <small class="pull-right"></small>
              </h2>
            </div>
